...
public class ContactmanagerApplication {
	...
	public CommandLineRunner demo(ContactRepository crepository, UserRepository urepository) {
		return (args) -> {
			...
			crepository.save(new Contact("Alice", "Chen", 24568, "aliceC@gmial.com", "Hakaniemenranta", 653));
			crepository.save(new Contact("John", "Simpson", 24568, "JsimpsonC@gmial.com", "Kaisaniemi", 653));
			crepository.save(new Contact("Alen", "Hakward", 2456, "ahakward@gmial.com", "Turuku", 653));
			crepository.save(new Contact("Simen", "Yan", 245, "SimenyC@gmial.com", "Temerpa", 653));
			crepository.save(new Contact("Kate", "Neilson", 245, "Kneilson@gmial.com", "Laperanta", 653));
